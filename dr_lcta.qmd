...
Sensitivity analyses were conducted by replicating the modelling on subsets of the population with at least three time-point observations to test classification robustness. After this step, we will assess the interpretability of the favoured model.
