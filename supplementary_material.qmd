...
models_to_plot <- list(
  ...
  "DGCC 2011–2019" = all_named_models[["4class_linear_nre_homocedastic_dgcc_model_2011_2019"]],
  "DRSC 2011–2023" = all_named_models[["4class_linear_nre_homocedastic_drsc_model_2011_2023"]],
  "DRSC 2011–2019" = all_named_models[["4class_linear_nre_homocedastic_drsc_model_2011_2019"]]
)
...
residual_data_all$model_label <- factor(residual_data_all$model_label, 
                                        levels = c("DGCC 2011–2023", "DGCC 2011–2019", "DRSC 2011–2023", "DRSC 2011–2019"))
...
plot_dgcc_2023 <- plot_residual_block(residual_data_all %>% filter(model_label == "DGCC 2011–2023"), "DGCC 2011–2023 – Structure A")
plot_dgcc_2019 <- plot_residual_block(residual_data_all %>% filter(model_label == "DGCC 2011–2019"), "DGCC 2011–2019 – Structure A")
plot_drsc_2023 <- plot_residual_block(residual_data_all %>% filter(model_label == "DRSC 2011–2023"), "DRSC 2011–2023 – Structure A")
plot_drsc_2019 <- plot_residual_block(residual_data_all %>% filter(model_label == "DRSC 2011–2019"), "DRSC 2011–2019 – Structure A")
...
#| fig-height: 14
#| fig-width: 10
#| fig-cap: "Figure S5. Latent class selection plots for DRSC (2011–2023)"
...
grolts_completed <- tibble::tibble(
  ...
  Reason = c(
    ...
    "Yes. Structures A–J tested with and without random effects.",
...
grolts_completed2 <- tibble::tibble(
  ...
  `Section Reported` = c(
    ...
    "Methods – Missing data handling",
    "Methods – Missing data handling",
    "Methods – Covariates description",
